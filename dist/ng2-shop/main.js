...
var routes = [{ path: ':status', component: _product_product_component__WEBPACK_IMPORTED_MODULE_2__["ProductComponent"] },
    { path: '**', redirectTo: '/all' }
];
...
var ProductComponent = /** @class */ (function () {
    ...
    ProductComponent.prototype.getProducts = function () {
        var _this = this;
        return this.productService.get().then(function (todos) {
            _this.todos = todos;
            _this.activeTasks = _this.todos.filter(function (todos) { return todos.isDone; }).length;
        });
    };
    ProductComponent.prototype.addTodo = function () {
        var _this = this;
        this.productService.add({ title: this.newTodo, isDone: false }).then(function () {
            return _this.getProducts();
        }).then(function () {
            _this.newTodo = ''; // clear input form value
        });
    };
    ProductComponent.prototype.updateTodo = function (todo, newValue) {
        var _this = this;
        todo.title = newValue;
        return this.productService.put(todo).then(function () {
            todo.editing = false;
            return _this.getProducts();
        });
    };
    ProductComponent.prototype.destroyTodo = function (todo) {
        var _this = this;
        this.productService.delete(todo).then(function () {
            return _this.getProducts();
        });
    };
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.get = function () {
        return new Promise(function (resolve) { return resolve(TODOS); });
    };
    ...
    ProductService.prototype.put = function (changed) {
        return new Promise(function (resolve) {
            var index = TODOS.findIndex(function (todo) { return todo === changed; });
            TODOS[index].title = changed.title;
            resolve(changed);
        });
    };
    ProductService.prototype.delete = function (selected) {
        return new Promise(function (resolve) {
            var index = TODOS.findIndex(function (todo) { return todo === selected; });
...
module.exports = __webpack_require__(/*! /home/shiva/Projects/ng2-shop/src/main.ts */"./src/main.ts");
